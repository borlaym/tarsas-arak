...
app.get('/deltavision/:query', function (req, res) {
    node_fetch_1.default("http://www.deltavision.hu/catalogsearch/result/?q=" + req.params.query)
        .then(function (r) { return r.text(); })
        .then(function (r) { return res.send(r); });
});
app.get('/tarsasjatekdiszkont/:query', function (req, res) {
    node_fetch_1.default("https://www.tarsasjatekdiszkont.hu/shop_search.php?search=" + req.params.query)
        .then(function (r) { return r.text(); })
        .then(function (r) { return res.send(r); });
});
